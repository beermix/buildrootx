...
HOST_CLANG_CONF_OPTS += -DPYTHON_EXECUTABLE=$(HOST_DIR)/bin/python2
HOST_CLANG_CONF_OPTS += -DBUILD_SHARED_LIBS=ON
HOST_CLANG_CONF_OPTS += -DLLVM_INCLUDE_DOCS=OFF
HOST_CLANG_CONF_OPTS += -DLLVM_INCLUDE_TESTS=OFF
HOST_CLANG_CONF_OPTS += -DLLVM_BUILD_TESTS=OFF
HOST_CLANG_CONF_OPTS += -DLLVM_BUILD_DOCS=OFF
